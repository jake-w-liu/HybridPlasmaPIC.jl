...
function case_19_integrator_camcl_semiimplicit(artifact_dir::AbstractString)
    ...
    rows = (
        (
            "camcl_ion_acoustic_relative_frequency_error",
            omega_camcl,
            omega_ref,
            "relative",
            camcl_relerr,
        ...
        (
            "camcl_vs_hybrid_frequency_relative_difference",
            omega_camcl,
            omega_hybrid,
            "relative",
            camcl_hybrid_relerr,
        ...
        (
            "cn_multiplier_modulus_error",
            abs(cn_multiplier(7.0, 0.3)),
            1.0,
            "absolute",
            cn_modulus_error,
            1e-14,
        ...
        (
            "cn_whistler_energy_ratio_error",
            cn.energy_ratio,
            1.0,
            "absolute",
            cn_energy_error,
        ...
        (
            "euler_stiff_growth_margin_error",
            euler.energy_ratio,
            1.1,
            "margin",
            euler_growth_error,
        ...
        (
            "compare_integrators_resolved_agreement_error",
            compare.agree_resolved,
            0.0,
            "absolute",
            compare.agree_resolved,
            1e-3,
        ...
        (
            "compare_integrators_cn_stiff_energy_error",
            compare.cn_ratio_stiff,
            1.0,
            "absolute",
            compare_cn_error,
            1e-12,
        ...
        (
            "compare_integrators_euler_stiff_growth_margin_error",
            compare.euler_ratio_stiff,
            10.0,
            "margin",
            compare_euler_growth_error,
            0.0,
        ),
    )
