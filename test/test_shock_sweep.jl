...
@testset "SHK-SWEEP perpendicular-shock Mach sweep" begin
    ...
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, γe = 1.0)
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, Te = -0.1)
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, η = NaN)
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, η = -0.1)
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, vthi = NaN)
    @test_throws ArgumentError run_perp_shock(; MA = 4.0, vthi = -0.1)
